export const reference = [{
  ...
  "elements": [{
    ...
    "name": "<link>",
    "description": "The <link> HTML element specifies relationships between the current document and an external resource. This element is most commonly used to link to CSS, but is also used to establish site icons (both \"favicon\" style icons and icons for the home screen and apps on mobile devices) among other things."
  }, {
    "name": "<meta>",
  ...
  "elements": [{
    ...
    "name": "<code>",
    "description": "The <code> HTML element displays its contents styled in a fashion intended to indicate that the text is a short fragment of computer code. By default, the content text is displayed using the user agent default monospace font."
  }, {
    "name": "<data>",
  ...
  "elements": [{
    "name": "<area>",
    "description": "The <area> HTML element defines an area inside an image map that has predefined clickable areas. An image map allows geometric areas on an image to be associated with Hyperlink."
  }, {
    "name": "<audio>",
  ...
  }, {"name": "<img>", "description": "The <img> HTML element embeds an image into the document."}, {
    "name": "<map>",
  ...
  "elements": [{
    ...
    "name": "<image>",
    "description": "The <image> HTML element is an obsolete remnant of an ancient version of HTML lost in the mists of time; use the standard img element instead. Seriously, the specification even literally uses the words \"Don't ask\" when describing this element."
  }, {
    "name": "<keygen>",
    ...
    "name": "<tt>",
    "description": "The <tt> HTML element creates inline text which is presented using the user agent default monospace font face. This element was created for the purpose of rendering text as it would be displayed on a fixed-width display such as a teletype, text-only screen, or line printer."
  }, {
    "name": "<xmp>",
